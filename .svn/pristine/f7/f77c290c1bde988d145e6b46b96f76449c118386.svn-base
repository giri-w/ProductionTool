...
namespace Demcon.ProductionTool.Model.Tests.LUTDetermination
{
    public class LUTTestStep0031 : TestStep
    {
            ...
            : base(testManager)
        {
            ...
            this.ButtonOptions = EButtonOptions.Analyze;
        ...
        public override void Execute(EButtonOptions userAction, string info)
        {
            ...
            {
                // Check or do something (with the hardware?) for the test
                String pythonLocation = "C:/Users/GWA/Desktop/Internship DEMCON/test4.py";
                String pythonArgument = "8"; //additional
                this.Results.Add(new BooleanResult("Result", run_cmd(pythonLocation, pythonArgument),true));
            }
