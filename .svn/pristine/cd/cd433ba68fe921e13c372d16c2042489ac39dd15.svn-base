# change dir work
import os.path
os.chdir('C:\\Users\\Girindra\\Desktop\\Internship Hunter\\1. Internship DEMCON\\2. Hemics production tools\\SignalStability\\-. Python Conversion\\') 
...
# user variable
from os import walk
mypath = "C:\\Users\\Girindra\\Desktop\\Internship Hunter\\1. Internship DEMCON\\2. Hemics production tools\\1. Test Source\\20170703_113239_297 SignalStability\\Raw data"
...
Lx4 = 195-1
Ly4 = 140-1
Lx5 = np.round(np.mean([Lx2,Lx3]))
Ly5 = np.round(np.mean([Ly2,Ly3]))
...
Rx4 = 256-Lx4+1
Ry4 = Ly4-1
Rx5 = np.round(np.mean([Rx2,Rx3]))
Ry5 = np.round(np.mean([Ry2,Ry3]))
