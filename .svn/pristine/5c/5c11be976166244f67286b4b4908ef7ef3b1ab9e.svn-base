def lut_table_compilation(grid_left, grid_right, output_path):
  ...
  write_xml(table, output_path + '\\PyLeft-MotorMatrix-High')

  table = calculate_table(grid_left, 'low')
  write_xml(table, output_path + '\\PyLeft-MotorMatrix-Low')

  table = calculate_table(grid_right, 'high')
  write_xml(table, output_path + '\\PyRight-MotorMatrix-High')

  table = calculate_table(grid_right, 'low')
  write_xml(table, output_path + '\\PyRight-MotorMatrix-Low')
  return
...
def write_xml(table,name_of_file):
  ...
  completeName = os.path.join(str(name_of_file) + ".xml")
  print(completeName)
