...
{
    public class FMGTestStep08 : TestStep
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericTestStep08"/> class.
        /// DO NOT USE! Only for Serializabililty!
        /// </summary>
        [Obsolete]
        public FMGTestStep08()
            : this(null)
        { }
        ...
        public override void Execute(EButtonOptions userAction, string info)
        {
            ...
            if (userAction == EButtonOptions.Analyze)
            {
                ...
                string[] pythonArgument = { fullPath, SourceLocation, Threshold.ToString(),"Left" }; //additional
                pyFullPath = fullPath;
