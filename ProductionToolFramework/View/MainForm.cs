...
namespace Demcon.ProductionTool.View
{
    public partial class MainForm : Form
    {
        ...
        private void linkStatus_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            // check the order of the panel
            int urutan = this.Controls.GetChildIndex(testPage1);
            int urutan2 = this.Controls.GetChildIndex(tabFatTests1);

            // only show the option when homescreen at front
            if (urutan2 < urutan)
            {
